...
public class Parser {
    ...
    public TokenStream toks;
   

    public void setToks(TokenStream t) {
        toks = t;
    }

    public ArrayList<Decl> parseDecls(TokenStream t) {
    ...
    public Decl parseDecl() throws ParseError {
     ...
     * side of an '='
     */
    public ArrayList<Pat> parselhs() throws ParseError {
    ...
    public Pat parseAPat() throws ParseError {
        return parsePat();
    }
     ...
     */
    public Pat parsePat() throws ParseError {
        Token t = toks.next();
        if (t.isNumber()) {
    ...
    public void prattReduce(ArrayList<Exp> exps, ArrayList<Token> ops, Token op) throws ParseError {
    ...
    public Exp parseFexp() throws ParseError {
    ...
    public Exp parseAExp() throws ParseError {
        Token t = toks.next();
        if (t.isNumber()) {            
        ...
        {
            Exp exp1 = parseExp();
            requirePunct(Symbol.thenKeyword);
            Exp exp2 = parseExp();
            requirePunct(Symbol.elseKeyword);
            Exp exp3 = parseExp();
     ...
     * -Adam A.
     */
    public void requirePunct(Symbol s) throws ParseError {
        Token t = toks.next();
        if (!t.isPunct(s)) {
